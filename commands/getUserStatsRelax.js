...
module.exports = function (client) {
    client.on("message", async message => {
        if (message.content.startsWith(prefix + "stats-r")) {
            var msg = message.content;
            msg = msg.split(prefix + "stats-r ");
            msg = msg[1];
            try {
                ...
                .addField(user[0].username + "\'s relax stats", "osu!STD pp: **" + userStats[0].pp_std + "**\nosu!Taiko pp: **" + userStats[0].pp_mania + "**\nosu!CTB pp: **" + userStats[0].pp_ctb + "**")
